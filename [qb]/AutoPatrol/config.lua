...
Config.Framework = 'QBCore' -- Can be 'ESX' or 'QBCore' or 'Standalone'
...
Config.Keybind = "LSHIFT" -- Registered Key Mapping under AutoPatrol. Input Parameters listed here: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
